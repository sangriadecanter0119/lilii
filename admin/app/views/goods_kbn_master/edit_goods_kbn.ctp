...
function SetChurchCode(){
    ...
    <form id="formID" class="content" method="post" action="" >
		...
		<table class="form" cellspacing="0">
          ...
          <tr>
             <th>教会コード</th>
             <td><input type="text" name="data[GoodsKbnMst][church_code]" id="church_code" class="validate[maxSize[2] inputshortalpha" value="<?php echo $data['GoodsKbnMst']['church_code'] ?>"/></td>
          </tr>
	    </table>
